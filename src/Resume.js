  ...
  <div className="col-container">
    <div className="left">
      ...
      <div className="job_heading">
        <h2><span className="bold">Knitting Patterns Galore</span> &mdash; <span className="italic">Full Stack Developer, Remote</span></h2>
      ...
      <div className="job_heading">
        <h2>
          <span className="bold">Russian Doska Network</span> &mdash; <span className="italic">Full Stack Developer, Remote</span>
        </h2>
        <h3>
      ...
      <div className="job_heading">
        <h2>
          <span className="bold">Advanced Embroidery Designs</span> &mdash; <span className="italic">PHP Developer &amp; Server Admin</span>
        </h2>
        <h3>
      ...
      <div className="job_heading">
        <h2>
          <span className="bold">Ariana RPG (voin.net)</span> &mdash; <span className="italic">PHP Developer, Remote</span>
        </h2>
        <h3>
          April 2003 - May 2005
        </h3>
      ...
      <div className="job_heading">
        <h2>
          <span className="bold">Freelance Work</span> &mdash; <span className="italic">Full Stack Developer &amp; &ldquo;Tech Handyman&rdquo;</span>
        </h2>
        <h3>
          2002 - 2019
        </h3>
      ...
      <div className="right">
        ...
        <ul>
          <li>PHP (<span className="italic">Laravel, Wordpress</span>)</li>
          <li>JavaScript (<span className="italic">React, Angular, Vue, NodeJS</span>)</li>
          <li>Python</li>
          <li>Ruby (<span className="italic">Rails, Jekyll</span>)</li>
          <li>Java</li>
          <li>HTML5 / CSS3</li>
          <li>SASS, SCSS</li>
          <li>SQL (<span className="italic">MySQL, PostgreSQL</span>)</li>
          <li>Perl</li>
          <li>Bash</li>
          <li>PowerShell</li>
          <li>Markdown</li>
        ...
        <ul>
          ...
          <li>Apache</li>
          <li>nginx</li>
          <li>Linux (<span className="italic">RHEL, Ubuntu Server</span>)</li>
        </ul>
      ...
      <h1>Education</h1>
      <h2>
        <span className="bold">Hartwick College, Oneonta, NY</span> &mdash; <span className="italic nobr">Bachelor of Arts (Biology)</span>
      </h2>
